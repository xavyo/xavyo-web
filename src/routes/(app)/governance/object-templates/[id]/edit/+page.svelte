<script lang="ts">
	...
	const { form, errors, enhance, message: formMessage } = superForm(data.form, {
		validators: zodClient(updateObjectTemplateSchema)
	});
</script>

<PageHeader title="Edit Template" description="Update template properties." />
...
<form method="POST" use:enhance class="max-w-2xl space-y-6">
	...
	<div class="flex gap-3">
		...
		<a
			href="/governance/object-templates/{data.template.id}"
